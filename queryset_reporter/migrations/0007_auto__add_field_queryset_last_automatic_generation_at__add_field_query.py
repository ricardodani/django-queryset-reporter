...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Queryset.last_automatic_generation_at'
        db.add_column('queryset_reporter_queryset', 'last_automatic_generation_at',
                      self.gf('django.db.models.fields.DateTimeField')(default=None),
                      keep_default=False)

        # Adding field 'Queryset.last_automatic_generation_csv'
        db.add_column('queryset_reporter_queryset', 'last_automatic_generation_csv',
                      self.gf('django.db.models.fields.CharField')(default=None, max_length=250),
                      keep_default=False)

        # Adding field 'Queryset.last_automatic_generation_xlsx'
        db.add_column('queryset_reporter_queryset', 'last_automatic_generation_xlsx',
                      self.gf('django.db.models.fields.CharField')(default=None, max_length=250),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Queryset.last_automatic_generation_at'
        db.delete_column('queryset_reporter_queryset', 'last_automatic_generation_at')

        # Deleting field 'Queryset.last_automatic_generation_csv'
        db.delete_column('queryset_reporter_queryset', 'last_automatic_generation_csv')

        # Deleting field 'Queryset.last_automatic_generation_xlsx'
        db.delete_column('queryset_reporter_queryset', 'last_automatic_generation_xlsx')
    ...
    models = {
        ...
        'queryset_reporter.queryset': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'last_automatic_generation_at': ('django.db.models.fields.DateTimeField', [], {}),
            'last_automatic_generation_csv': ('django.db.models.fields.CharField', [], {'max_length': '250'}),
            'last_automatic_generation_xlsx': ('django.db.models.fields.CharField', [], {'max_length': '250'}),
