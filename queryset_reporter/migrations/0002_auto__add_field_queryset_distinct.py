...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Queryset.distinct'
        db.add_column('queryset_reporter_queryset', 'distinct',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Queryset.distinct'
        db.delete_column('queryset_reporter_queryset', 'distinct')
