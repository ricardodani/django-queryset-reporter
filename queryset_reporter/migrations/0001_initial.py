...
import queryset_reporter.models
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('model', models.ForeignKey(limit_choices_to={'pk__in': queryset_reporter.models.Queryset._MODEL_CHOICES}, on_delete=django.db.models.deletion.CASCADE, to='contenttypes.ContentType', verbose_name='Modelo')),
            ],
            options={
