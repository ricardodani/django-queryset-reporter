...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'QueryFilter.readonly'
        db.add_column('queryset_reporter_queryfilter', 'readonly',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'QueryFilter.readonly'
        db.delete_column('queryset_reporter_queryfilter', 'readonly')
