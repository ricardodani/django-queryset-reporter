...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'QueryFilter.value'
        db.delete_column('queryset_reporter_queryfilter', 'value')

        # Deleting field 'QueryFilter.value_2'
        db.delete_column('queryset_reporter_queryfilter', 'value_2')

        # Adding field 'QueryFilter.field_type'
        db.add_column('queryset_reporter_queryfilter', 'field_type',
                      self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True),
                      keep_default=False)

        # Adding field 'DisplayField.field_type'
        db.add_column('queryset_reporter_displayfield', 'field_type',
                      self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'QueryFilter.value'
        db.add_column('queryset_reporter_queryfilter', 'value',
                      self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True),
                      keep_default=False)

        # Adding field 'QueryFilter.value_2'
        db.add_column('queryset_reporter_queryfilter', 'value_2',
                      self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True),
                      keep_default=False)

        # Deleting field 'QueryFilter.field_type'
        db.delete_column('queryset_reporter_queryfilter', 'field_type')

        # Deleting field 'DisplayField.field_type'
        db.delete_column('queryset_reporter_displayfield', 'field_type')
