...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Queryset.automatic_generation'
        db.add_column('queryset_reporter_queryset', 'automatic_generation',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Queryset.automatic_generation'
        db.delete_column('queryset_reporter_queryset', 'automatic_generation')
